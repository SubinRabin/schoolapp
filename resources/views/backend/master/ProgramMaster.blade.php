...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12">
            <h4 class="pull-left page-title">@lang('messages.lbl_ProgramList')</h4>
            <ol class="breadcrumb pull-right">
                <span><button class="btn btn-primary" onclick="programModalfun('')" >@lang('messages.lbl_AddProgram')</button></span>
            </ol>
        </div>
    </div>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <table id="Programdatatable" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th>@lang('messages.lbl_id')</th>
                                        <th>@lang('messages.lbl_ProgramName')</th>
