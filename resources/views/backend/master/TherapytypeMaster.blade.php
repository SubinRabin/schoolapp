...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12">
            <h4 class="pull-left page-title">@lang('messages.lbl_TherapyTypes')</h4>
            <ol class="breadcrumb pull-right">
                <span><button class="btn btn-primary" onclick="therapyTypeModalfun('')" >@lang('messages.lbl_Addtherapytype')</button></span>
            </ol>
        </div>
    </div>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <table id="therapyTypetable" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th>@lang('messages.lbl_id')</th>
                                        <th>@lang('messages.lbl_TherapyTypes')</th>
...
<div id="therapytypeModal" class="modal fade" role="dialog">
</div>
...
function  therapyTypeTable() {
    $('#therapyTypetable').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                ajax: 'master/therapyTypeList',
"language": {
              "paginate": {
              ...
              "infoFiltered": "(_MAX_ <?php echo trans('messages.lbl_DTtotalentries') ?>)",
                ...
                {data: 'therapyType', name: 'therapyType'},
