...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12">
            <h4 class="pull-left page-title">@lang('messages.lbl_TherapistList')</h4>
            <ol class="breadcrumb pull-right">
                <span><button class="btn btn-primary" onclick="therapistSubmitModalfun('')" >@lang('messages.lbl_AddTherapist')</button></span>
            </ol>
        </div>
    </div>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <table id="therapistTable" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
