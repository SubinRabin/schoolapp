        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body"> 
                    <input type="hidden" id="username" value="<?php echo session::get('AdminID'); ?>">
                    <input type="hidden" id="type" value="<?php echo isset($_REQUEST['type']) ? strtolower($_REQUEST['type']) : '' ?>">
                    <input type="hidden" id="receiverId" value="<?php echo isset($_REQUEST['receiverId']) ? $_REQUEST['receiverId'] : '' ?>">
...
{!! HTML::script('resources/assets/backend/js/chat.js') !!}
