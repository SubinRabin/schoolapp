            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="panel-title">
                        ...
                        <?php if ($inboxdata[0]->sender==session::get('StudentID')) {
                             $sender =   $inboxdata[0]->receiver; 
                        } else {
                             $sender =   $inboxdata[0]->sender; 
                        }
                        if ($inboxdata[0]->AdminRole==2) {
                         ?>
                        <a href="{{ url('compose?msgId='.$inboxdata[0]->id.'&replyId='.$sender) }}">Reply</a>
                    <?php } ?>
                        </span></h4>
                    </div>
                </div>
                <div class="panel-body">
                    ...
                    <div class="inbox-widget nicescroll mx-box">
                        <?php foreach ($relinboxdata as $key => $value) {
                         ...
                         ?>
                            <a href="{{ url('/inboxView?msgId='.$value->id.'&sender='.$value->SendName) }}">
